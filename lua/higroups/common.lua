...
function M.setup(c)
  return {
    ...
    buttons = {
      ...
      BtnPurple             = { bg = hi().tone(c.purple.hex, 0.50, 0.40),                       bold = true },
      BtnGreyPurple         = { bg = hi().tone(c.grey_purple.hex, 0.50, 0.40),                  bold = true },
      BtnPurpleSolid        = { fg = c.purple.hex, bg = hi().tone(c.purple.hex,   0.50, 0.40),  bold = true },
    ...
    lang = {
      ...
      cssSelectorOp                       = { fg = c.magenta.hex          },
      ...
      pythonOperator                      = { fg = c.magenta.hex          },
      ...
      typescriptArrowFunc                 = { fg = c.magenta.hex          },
